...
7 info angular-seed@0.0.0 Failed to exec prestart script
8 verbose stack Error: angular-seed@0.0.0 prestart: `npm install`
...
9 verbose pkgid angular-seed@0.0.0
10 verbose cwd D:\CPSC\4261\liveJudgingWeb\node_modules
11 error Windows_NT 6.1.7601
12 error argv "C:\\Program Files (x86)\\nodejs\\\\node.exe" "C:\\Program Files (x86)\\nodejs\\node_modules\\npm\\bin\\npm-cli.js" "start"
13 error node v0.12.4
14 error npm  v2.10.1
15 error code ELIFECYCLE
16 error angular-seed@0.0.0 prestart: `npm install`
16 error Exit status 1
17 error Failed at the angular-seed@0.0.0 prestart script 'npm install'.
17 error This is most likely a problem with the angular-seed package,
...
17 error     npm owner ls angular-seed
